...
|--------|-------------------|-------|-----------|
| Module 1 | `attendee-manual/exercises/module-1/soc-triage-template/SKILL.md` | `attendee-manual/03-module-1.md` | `lab/checkpoints/module-1/soc-triage/` |
| Module 2 | `lab/exercises/module-2/skeleton.json` (n8n workflow `SOC triage, build here (skeleton)`) | `attendee-manual/04-module-2.md` | `SOC triage, Module 2 checkpoint (LLM chain)` |
| Module 3 | the attendee's own Module 2 workflow, duplicated | `attendee-manual/05-module-3.md` | `SOC triage, Module 3 checkpoint (AI Agent)` |
...
Every module's exercises, exact expressions and expected outcomes live in the attendee manual chapter for that module (`attendee-manual/03-module-1.md`, `04-module-2.md`, `05-module-3.md`).
...
```bash
mkdir -p attendee-manual/exercises/module-1/screenshots
