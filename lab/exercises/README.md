...
| Module 2 | `lab/exercises/module-2/skeleton.json` (n8n workflow `SOC triage, build here (skeleton)`) and the two paste files in `exercises/module-2/` | `guide/04-module-2.md` | `SOC triage, Module 2 checkpoint (LLM chain)` |
