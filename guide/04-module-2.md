...
The workflow now runs end to end. This exercise is the functional test: given a real case, when nobody touches a keyboard, then the verdict lands on the case with no red node.
