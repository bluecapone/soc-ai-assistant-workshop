...
Your lab is a Docker compose stack on your own laptop: **TheHive**, **n8n**, **Wazuh**, the **Range control panel** and **bank-web**, the target that is vulnerable on purpose. This module starts it and proves it produces log data. *Module 1 needs the case Exercise 0.3 gives you.*
